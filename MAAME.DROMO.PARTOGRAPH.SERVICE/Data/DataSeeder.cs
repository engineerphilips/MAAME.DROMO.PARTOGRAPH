    ...
    public class DataSeeder
    {
        ...
        private List<District> GetGhanaDistricts()
        {
            ...
            districts.AddRange(new[]
            {
                ...
                CreateDistrict("22222222-2222-2222-2222-222222220047", "Atwima Nwabiagya Municipal", "ANMA", "Municipal", ashantiId, "Ashanti", "Nkawie", 161188, 4836),
            ...
            districts.AddRange(new[]
            {
                ...
                CreateDistrict("22222222-2222-2222-2222-222222220139", "Akatsi South District", "AKSDA2", "District", voltaId, "Volta", "Akatsi", 115629, 3469),
                CreateDistrict("22222222-2222-2222-2222-222222220140", "Akatsi North District", "AKNDA", "District", voltaId, "Volta", "Ave Dakpa", 57000, 1710),
