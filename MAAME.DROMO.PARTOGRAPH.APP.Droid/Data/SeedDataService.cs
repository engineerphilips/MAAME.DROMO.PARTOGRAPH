...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    public class SeedDataService
    {
        ...
        public SeedDataService(ProjectRepository projectRepository, TaskRepository taskRepository, TagRepository tagRepository, CategoryRepository categoryRepository, PatientRepository patientRepository, PartographEntryRepository partographRepository, VitalSignRepository vitalSignRepository, ILogger<SeedDataService> logger)
        {
        ...
        private async Task CreateSamplePartographEntries(Patient patient)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                var entry = new PartographEntry
                {
                    PatientID = patient.ID,
                    RecordedTime = startTime.AddMinutes(i * 30),
