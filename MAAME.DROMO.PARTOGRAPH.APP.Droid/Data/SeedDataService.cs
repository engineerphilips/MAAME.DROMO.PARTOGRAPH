...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    public class SeedDataService
    {
        ...
        //ProjectRepository projectRepository, TaskRepository taskRepository, TagRepository tagRepository, CategoryRepository categoryRepository, VitalSignRepository vitalSignRepository, 
        public SeedDataService(PatientRepository patientRepository, PartographRepository partographRepository, ILogger<SeedDataService> logger)
        {
        ...
        public async Task LoadSamplePartographData()
        {
            try
            {
                ...
                var patients = new List<Partograph>
                {
                    new() {
                        ...
                        Parity = 1,
                        Gravida = 2,
                        ExpectedDeliveryDate = DateOnly.FromDateTime(DateTime.Now.AddDays(2)),
                        //GestationalAge = "38 weeks",
                        DeliveryTime = null,
                        DeletedTime = null,
                        Status = LaborStatus.FirstStage,
                     ...
                     new Partograph
                    {
                        ...
                        Parity = 0,
                        Gravida = 1,
                        ExpectedDeliveryDate = DateOnly.FromDateTime(DateTime.Now.AddDays(5)),
                        //GestationalAge = "38 weeks",
                        DeliveryTime = null,
                        DeletedTime = null,
                    ...
                    new Partograph
                    {
                        ...
                        ExpectedDeliveryDate = DateOnly.FromDateTime(DateTime.Now.AddDays(-1)),
                    ...
                    new Partograph
                    {
                        ...
                        ExpectedDeliveryDate = DateOnly.FromDateTime(DateTime.Now),
                        Status = LaborStatus.FirstStage,
                        ...
                        Patient = new Patient
                    {
                        ...
                        DateOfBirth = new DateOnly(1994, 7, 22),
                        Age = 30,
                        BloodGroup = "AB+",
                        ...
                        Patient = new Patient
                    {
                        ...
                        DateOfBirth = new DateOnly(1989, 4, 15),
                        Age = 35,
                        BloodGroup = "O-",
                ...
                {
                    await _patientRepository.SaveItemAsync(patient.Patient);
