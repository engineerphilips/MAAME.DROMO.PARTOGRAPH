...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    ...
    public class HeadDescentRepository : BasePartographRepository<HeadDescent>
    {
        ...
        INSERT INTO Tbl_HeadDescent (ID, partographID, time, handler, notes, station, createdtime, updatedtime, deletedtime, deviceid, origindeviceid, syncstatus, version, serverversion, deleted)
        VALUES (@id, @partographId, @time, @handler, @notes, @station, @createdtime, @updatedtime, @deletedtime, @deviceid, @origindeviceid, @syncstatus, @version, @serverversion, @deleted);";
