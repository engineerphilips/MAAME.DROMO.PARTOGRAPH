    ...
    public class BabyDetailsRepository
    {
        ...
        public async Task<List<BabyDetails>> GetByPartographIdAsync(Guid? partographId)
        {
            ...
            try
            {
                ...
                selectCmd.CommandText = @"SELECT b.*, s.name as staffname
                    ...
                    WHERE b.partographid = @partographid AND b.deleted = 0 ORDER BY b.babynumber";
        ...
        public async Task<List<BabyDetails>> GetByBirthOutcomeIdAsync(Guid? birthOutcomeId)
        {
            ...
            try
            {
                ...
                selectCmd.CommandText = @"SELECT b.*, s.name as staffname
                    FROM Tbl_Baby b
                    LEFT JOIN Tbl_Staff s ON b.handler = s.ID
                    WHERE b.birthoutcomeid = @birthoutcomeid AND b.deleted = 0 ORDER BY b.babynumber";
        ...
        public async Task<List<BabyDetails>> ListAsync()
        {
            ...
            try
            {
                ...
                selectCmd.CommandText = @"SELECT b.*, s.name as staffname
                    FROM Tbl_Baby b
                    LEFT JOIN Tbl_Staff s ON b.handler = s.ID
                    WHERE b.deleted = 0 ORDER BY b.babynumber";
                //selectCmd.Parameters.AddWithValue("@birthoutcomeid", birthOutcomeId.ToString());
        ...
        private string GetInsertSql()
        {
            ...
            INSERT INTO Tbl_Baby (
                ...
                chestcircumference, apgar1min, apgar5min,
                apgar1heartrate, apgar1respiratoryeffort, apgar1muscletone, apgar1reflexirritability, apgar1color,
                apgar5heartrate, apgar5respiratoryeffort, apgar5muscletone, apgar5reflexirritability, apgar5color,
                resuscitationrequired, resuscitationsteps, resuscitationduration, oxygengiven, intubationperformed,
        ...
        private string GetUpdateSql()
        {
            ...
            UPDATE Tbl_Baby SET
                ...
                apgar1min = @apgar1min, apgar5min = @apgar5min,
