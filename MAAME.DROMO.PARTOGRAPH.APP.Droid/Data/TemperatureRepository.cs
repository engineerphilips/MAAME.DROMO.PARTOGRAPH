...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    ...
    public class TemperatureRepository : BasePartographRepository<Temperature>
    {
        ...
        protected override string CreateTableSql => @"
            ...
            CREATE INDEX idx_temperature_sync ON Tbl_Temperature(updatedtime, syncstatus);
            CREATE INDEX idx_temperature_server_version ON Tbl_Temperature(serverversion);
        ...
        protected override Temperature MapFromReader(SqliteDataReader reader)
        {
            return new Temperature
            {
                ...
                Rate = reader.IsDBNull(5) ? null : reader.GetFloat(5),
        ...
        INSERT INTO Tbl_Temperature (ID, partographID, time, handler, notes, rate, createdtime, updatedtime, deletedtime, deviceid, origindeviceid, syncstatus, version, serverversion, deleted)
