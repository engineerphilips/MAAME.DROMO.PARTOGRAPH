...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    ...
    public class CaputRepository : BasePartographRepository<Caput>
    {
        ...
        INSERT INTO Tbl_Caput (ID, partographID, time, handler, notes, degree, createdtime, updatedtime, deletedtime, deviceid, origindeviceid, syncstatus, version, serverversion, deleted)
