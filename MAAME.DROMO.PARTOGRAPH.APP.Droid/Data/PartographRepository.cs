    ...
    public class PartographRepository
    {
        ...
        protected Partograph MapFromReader(SqliteDataReader reader)
        {
            return new Partograph
            {
                ...
                AdmissionDate = DateTime.Parse((string)reader["admissionDate"]),
                ExpectedDeliveryDate = reader["expectedDeliveryDate"] is DBNull ? null : DateOnly.Parse((string)reader["expectedDeliveryDate"]),
                LastMenstrualDate = reader["lastMenstrualDate"] is DBNull ? null : DateOnly.Parse((string)reader["lastMenstrualDate"]),
                LaborStartTime = reader["laborStartTime"] is DBNull ? null : DateTime.Parse((string)reader["laborStartTime"]),
                SecondStageStartTime = reader["secondStageStartTime"] is DBNull ? null : DateTime.Parse((string)reader["secondStageStartTime"]),
                ThirdStageStartTime = reader["thirdStageStartTime"] is DBNull ? null : DateTime.Parse((string)reader["thirdStageStartTime"]),
                FourthStageStartTime = reader["fourthStageStartTime"] is DBNull ? null : DateTime.Parse((string)reader["fourthStageStartTime"]),
                DeliveryTime = reader["deliveryTime"] is DBNull ? null : DateTime.Parse((string)reader["deliveryTime"]),
                CompletedTime = reader["completedTime"] is DBNull ? null : DateTime.Parse((string)reader["completedTime"]),
                RupturedMembraneTime = reader["rupturedMembraneTime"] is DBNull ? null : DateTime.Parse((string)reader["rupturedMembraneTime"]),
                ...
                MembraneStatus = reader["membraneStatus"] is DBNull ? "Intact" : (string)reader["membraneStatus"],
                LiquorStatus = reader["liquorStatus"] is DBNull ? "Clear" : (string)reader["liquorStatus"],
                Complications = reader["complications"] is DBNull ? "" : (string)reader["complications"],
                ...
                Patient = new Patient
                {
                    ID = reader["patientID"] is DBNull ? null : Guid.Parse((string)reader["patientID"]),
