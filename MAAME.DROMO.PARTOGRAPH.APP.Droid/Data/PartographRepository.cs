...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    public class PartographRepository
    {
        ...
        protected Partograph MapFromReader(SqliteDataReader reader)
        {
            ...
            var gravidaOrdinal = reader.GetOrdinal("gravida");
            var parityOrdinal = reader.GetOrdinal("parity");
            var abortionOrdinal = reader.GetOrdinal("abortion");
            var admissionDateOrdinal = reader.GetOrdinal("admissionDate");
            var expectedDeliveryDateOrdinal = reader.GetOrdinal("expectedDeliveryDate");
            var lastMenstrualDateOrdinal = reader.GetOrdinal("lastMenstrualDate");
            var laborStartTimeOrdinal = reader.GetOrdinal("laborStartTime");
            var secondStageStartTimeOrdinal = reader.GetOrdinal("secondStageStartTime");
            var thirdStageStartTimeOrdinal = reader.GetOrdinal("thirdStageStartTime");
            var fourthStageStartTimeOrdinal = reader.GetOrdinal("fourthStageStartTime");
            var deliveryTimeOrdinal = reader.GetOrdinal("deliveryTime");
            var completedTimeOrdinal = reader.GetOrdinal("completedTime");
            var rupturedMembraneTimeOrdinal = reader.GetOrdinal("rupturedMembraneTime");
            var cervicalDilationOnAdmissionOrdinal = reader.GetOrdinal("cervicalDilationOnAdmission");
            var membraneStatusOrdinal = reader.GetOrdinal("membraneStatus");
            var liquorStatusOrdinal = reader.GetOrdinal("liquorStatus");
            var complicationsOrdinal = reader.GetOrdinal("complications");
            ...
            return new Partograph
            {
                ...
                Status = (LaborStatus)reader.GetInt32(statusOrdinal),
                Gravida = reader.GetInt32(gravidaOrdinal),
                Parity = reader.GetInt32(parityOrdinal),
                Abortion = reader.GetInt32(abortionOrdinal),
                AdmissionDate = DateTime.Parse(reader.GetString(admissionDateOrdinal)),
                ExpectedDeliveryDate = reader.IsDBNull(expectedDeliveryDateOrdinal) ? null : DateOnly.Parse(reader.GetString(expectedDeliveryDateOrdinal)),
                LastMenstrualDate = reader.IsDBNull(lastMenstrualDateOrdinal) ? null : DateOnly.Parse(reader.GetString(lastMenstrualDateOrdinal)),
                LaborStartTime = reader.IsDBNull(laborStartTimeOrdinal) ? null : DateTime.Parse(reader.GetString(laborStartTimeOrdinal)),
                SecondStageStartTime = reader.IsDBNull(secondStageStartTimeOrdinal) ? null : DateTime.Parse(reader.GetString(secondStageStartTimeOrdinal)),
                ThirdStageStartTime = reader.IsDBNull(thirdStageStartTimeOrdinal) ? null : DateTime.Parse(reader.GetString(thirdStageStartTimeOrdinal)),
                FourthStageStartTime = reader.IsDBNull(fourthStageStartTimeOrdinal) ? null : DateTime.Parse(reader.GetString(fourthStageStartTimeOrdinal)),
                DeliveryTime = reader.IsDBNull(deliveryTimeOrdinal) ? null : DateTime.Parse(reader.GetString(deliveryTimeOrdinal)),
                CompletedTime = reader.IsDBNull(completedTimeOrdinal) ? null : DateTime.Parse(reader.GetString(completedTimeOrdinal)),
                RupturedMembraneTime = reader.IsDBNull(rupturedMembraneTimeOrdinal) ? null : DateTime.Parse(reader.GetString(rupturedMembraneTimeOrdinal)),
                CervicalDilationOnAdmission = reader.IsDBNull(cervicalDilationOnAdmissionOrdinal) ? null : reader.GetInt32(cervicalDilationOnAdmissionOrdinal),
                MembraneStatus = reader.IsDBNull(membraneStatusOrdinal) ? "Intact" : reader.GetString(membraneStatusOrdinal),
                LiquorStatus = reader.IsDBNull(liquorStatusOrdinal) ? "Clear" : reader.GetString(liquorStatusOrdinal),
                Complications = reader.IsDBNull(complicationsOrdinal) ? "" : reader.GetString(complicationsOrdinal),
                ...
                Patient = new Patient
                {
                    ID = reader.IsDBNull(patientIdOrdinal) ? null : Guid.Parse(reader.GetString(patientIdOrdinal)),
