...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    ...
    public class AssessmentRepository : BasePartographRepository<Assessment>
    {
        ...
        protected override string CreateTableSql => @"
            ...
            CREATE INDEX IF NOT EXISTS idx_assessment_partographid ON Tbl_Assessment(partographid);
        ...
        protected override string GetInsertSql() => @"
            INSERT INTO Tbl_Assessment (ID, partographID, time, handler, notes, createdtime, updatedtime, deletedtime, deviceid, origindeviceid, syncstatus, version, serverversion, deleted, datahash)
        ...
        protected override string GetUpdateSql() => @"
            UPDATE Tbl_Assessment SET time = @time, handler = @handler, notes = @notes, 
