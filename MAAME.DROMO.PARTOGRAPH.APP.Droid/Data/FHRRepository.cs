...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid.Data
{
    ...
    public class FHRRepository : BasePartographRepository<FHR>
    {
        ...
        INSERT INTO Tbl_FHR (ID, partographID, time, handler, notes, rate, createdtime, updatedtime, deletedtime, deviceid, origindeviceid, syncstatus, version, serverversion, deleted)
