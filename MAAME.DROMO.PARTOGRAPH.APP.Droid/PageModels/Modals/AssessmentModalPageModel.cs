...
{
    public partial class AssessmentModalPageModel : ObservableObject
    {
        ...
        public AssessmentModalPageModel(AssessmentRepository repository, ModalErrorHandler errorHandler)
        {
        ...
        internal async Task LoadPatient(Guid? patientId)
        {
            try
            {
                ...
                var lastEntry = await _assessmentRepository.GetLatestByPatientAsync(patientId);
                if (lastEntry != null)
                {
        ...
        private async Task Save()
        {
            ...
            try
            {
                ...
                if (await _assessmentRepository.SaveItemAsync(entry) != null)
                {
                    await AppShell.DisplayToastAsync("Assessment saved successfully");
