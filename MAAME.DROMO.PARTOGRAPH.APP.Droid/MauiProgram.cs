...
namespace MAAME.DROMO.PARTOGRAPH.APP.Droid
{
    ...
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<PartographMonitoringService>(); // Active labour monitoring with notifications
            ...
            //builder.Services.AddTransientWithShellRoute<PatientPage, PatientPageModel>("newpatient");
            ...
            builder.Services.AddTransientWithShellRoute<PartographDetailsPage, PartographDetailsPageModel>("partographdetails");
