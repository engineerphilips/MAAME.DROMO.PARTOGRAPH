        ...
        try
        {
            ...
            command.CommandText = @"
                SELECT
                    ...
                    P.complications, P.handlername, P.handler, P.facilityid,
                    ...
                    PA.facilityid as patient_facilityid,
    ...
    private Partograph MapPartographFromReader(SqliteDataReader reader)
    {
        return new Partograph
        {
            ...
            Patient = new Patient()
            {
                ...
                FacilityID = reader["patient_facilityid"] is DBNull ? null : Guid.Parse(reader["patient_facilityid"].ToString()!),
